...
def cnn_model_func(ob_space, ac_space): return MLPModel(ob_space, ac_space, kind='large')
...
def main():
    ...
    with tf.device(args.worker_device):
        ppo = PPO(env.observation_space, env.action_space, mlp_model_func, clip_param=0.2, entcoeff=0.01)
